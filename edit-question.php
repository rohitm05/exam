...
<html lang="en">
 ...
 <h2 style="text-align: center">EDIT QUESTION</h2>
   ...
   <?php $query="select id,category_id,question,answer1,answer2,answer3,answer4,correct_ans from question  where id='".$_REQUEST['id']."'"; 
   ...
   <form class="form-horizontal" action="update-question.php" method="post">
      ...
      <div class="col-sm-10"> 
      	<?php $query="select id, category_name from category where id='".$arr['category_id']."'";
      	$result=mysqli_query($con,$query); 
      	?>
      <select class="form-control" id="category_id" name="category_id">
      	 <?php while ($arr1=mysqli_fetch_array($result,MYSQLI_BOTH)):
         ?>
        <option <?php if($arr1['id']==$arr['id']) echo "selected"; ?> value="<?php echo $arr1['id'] ?>"><?php echo $arr1['category_name'] ?></option>
        <?php endwhile; ?>
      </select>
  </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="question" name="question" placeholder="Question" value="<?php echo $arr['question'] ?>">
    </div>
  </div>
  <div class="form-group">
